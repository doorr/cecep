                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
					oc = ["Nah loh ngapain kamu ngintip " + "☞ " + nick[0] + " ☜" + "\nMendingan sini masuk ngobrol bareng kita kita","Masuk " + "☞ " + nick[0] + " ☜" + "\nNgapain pakek ngintip segala","Jangan ngintip aja " + "☞ " + nick[0] + " ☜" + "\nNtar kesurupan baru tau rasa kamu...","Tuch kan si " + "☞ " + nick[0] + " ☜" + " ngintip lagi","Awas bintitan ya kamu " + "☞ " + nick[0] + " ☜" + " ngintip terus"]
					ab = random.choice(oc)
                                        cl.sendText(op.param1, ab)
                                    else:
					ob = ["Nah kan " + "☞ " + nick[1] + " ☜" + "\nBetah banget jadi tukang nyimak","Woiii... " + "☞ " + nick[1] + " ☜" + "\nNgapain nyimak mulu, masuk sini","Aaiihh.... Si " + "☞ " + nick[1] + " ☜" + " jadi tukang minyak sekarang","Nah loh si " + "☞ " + nick[1] + " ☜" + "nyimak apaan sich"]
					ac = random.choice(ob)
                                        cl.sendText(op.param1, ac)
                                else:
				    oa = ["Woii " + "☞ " + Name + " ☜" + "\nNgapain ngumpet","Keluar donk " + "☞ " + Name + " ☜" + "\nMasa cuma ngintip dan nyimak doank","Tuh kan si " + "☞ " + Name + " ☜" + " ngintip lagi... \nChat donk biar seru..."]
				    ad = random.choice(oa)
                                    cl.sendText(op.param1, ad)
                        else:
                            pass
                    else:
                        pass
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["Cie " + cName + " yang baru belajar tag, lemesin jari ya","Alay banget sich maen tag mulu " + cName,cName + " Ngapain Ngetag \nGak ada bosennya tag gw mulu?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja",cName + " Sekali tag denda 100c","Nah loh " + cName + " ngapain tag gw...", cName + " Kangen ya tag gw, sini gw peluk","Kalau penting PM aja, gak usah tag  " + cName,cName + " Gak tak di gc kalau mau ngajak nikung, PM aja langsung", "Cie tag gw mulu si " + cName + " ngajak nikung ya", "Gak usah tag " + cName + " kalau mau ngajak VC langsung PM aja ","Kasian banget si " + cName + " ngetag mulu, pasti lagi jones ya"]
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["kickMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Tagall",cName + " Males banget ya kamu, Tag member aja pakek bot",cName + " Ach dasar bot pemalas pakek tagall","Anjiiir gw di perkosa bot", cName + " Kenapa Tag saya?","SPAM PC aja " + cName, "Jangan Suka Tag gua " + cName, "Kamu siapa " + cName + "?", "Ada Perlu apa " + cName + "?","Tenggelamkan tuh yang suka tag pake BOT","Tersummon -_-"]
...
#==============================================================================#
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "ucbdd928005d353a443cd2e071c8243cd"}
                cl.sendMessage(msg)
...
#==============================================================================#
	    ...
	    elif msg.text in ["Cctv on","cctv on"]:
	    ...
	    elif msg.text in ["Cctv off","cctv off"]:
	    ...
	    elif msg.text in ["Cyduk","cyduk","Ciduk","ciduk"]:
		if msg.to in wait2['readPoint']:
	    ...
	    elif msg.text in ["Cyduk1","cyduk1","Ciduk1","ciduk1"]:
		if msg.to in wait2['readPoint']:
		    if wait2["ROM"][msg.to].items() == []:
			chiya = ""
		    else:
		    ...
		    cl.sendText(msg.to, "||Di ReadOleh||%s\n||By : Gepeng ||\n\n>Pelaku CCTV<\n>KALIAN TERCYDUK<\n%s-=CCTV=-\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
		else:
